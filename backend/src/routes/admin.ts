...
export async function adminRoutes(
        ...
        recentActivity: [
          {
            ...
            type: 'EVENT_CREATED',
            description:
              'New Event Created: "Milano Design Week 2024" by Design Studio Milano',
  ...
  fastify.get(
    ...
    async (request, reply) => {
      const { page, limit, search, status } = request.query as z.infer<
        typeof adminRoutes.querystring
      >;
  ...
  fastify.get(
    ...
    async (request, reply) => {
      const { page, limit, status, search } = request.query as z.infer<
        typeof adminRoutes.querystring
      >;
