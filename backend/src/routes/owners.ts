...
export async function ownerRoutes(fastify: FastifyInstance, options: FastifyPluginOptions) {
  // Register as owner
  ...
  fastify.get('/events', {
    ...
    const { page, limit, status } = request.query as z.infer<typeof ownerRoutes.querystring>
