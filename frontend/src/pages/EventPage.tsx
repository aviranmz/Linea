          ...
          <div className='p-8'>
            <div className='prose max-w-none'>
              ...
              <p className='text-gray-600 mb-6'>
                ...
                This exclusive event showcases cutting-edge design, innovative
                products, and creative installations from leading designers and
                brands worldwide.
              </p>
              ...
              <div className='bg-gray-50 p-4 rounded-lg mb-6'>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                  <div>
                    <strong>Date:</strong> April 15-21, 2024
                    <br />
                  ...
                  <div>
                    ...
                    <br />
                    <strong>Waitlist:</strong> 1,234 people
                    <br />
                    <strong>Status:</strong>{' '}
                    <span className='text-green-600'>Open for Waitlist</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className='bg-primary-50 p-6 rounded-lg'>
              ...
              <p className='text-gray-600 mb-4'>
                This event is currently at capacity, but you can join our
              ...
              <div className='flex gap-4'>
                ...
                />
                <button className='btn btn-primary px-6'>Join Waitlist</button>
              </div>
