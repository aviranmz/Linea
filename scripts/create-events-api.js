  ...
  // Owner 2 Events (Sarah Johnson - Creative Events Co.)
  {
    ...
    events: [
      ...
      },
      {
        ...
        ).toISOString(), // Next Friday
        endDate: new Date(
          Date.now() + 12 * 24 * 60 * 60 * 1000 + 3 * 60 * 60 * 1000
        ).toISOString(),
        capacity: 75,
        venue: {
          name: 'Grand Ballroom NYC',
    ...
    events: [
      {
        ...
        endDate: new Date(
          Date.now() + 9 * 24 * 60 * 60 * 1000 + 6 * 60 * 60 * 1000
        ).toISOString(),
        capacity: 200,
        venue: {
      ...
      },
      {
        ...
        ).toISOString(), // Next Thursday
        endDate: new Date(
          Date.now() + 11 * 24 * 60 * 60 * 1000 + 4 * 60 * 60 * 1000
        ).toISOString(),
        capacity: 150,
        venue: {
      ...
      },
      {
        ...
        ).toISOString(), // Next Saturday
        endDate: new Date(
          Date.now() + 13 * 24 * 60 * 60 * 1000 + 5 * 60 * 60 * 1000
        ).toISOString(),
        capacity: 80,
        venue: {
          name: 'Silicon Valley Convention Center',
...
events.forEach((ownerData, index) => {
  ...
  console.log(
    `📍 Location: ${ownerData.owner.city}, ${ownerData.owner.country}`
  );
...
console.log(
  `• Total Events: ${events.reduce((sum, owner) => sum + owner.events.length, 0)}`
);
console.log(
  `• Featured Events: ${events.reduce((sum, owner) => sum + owner.events.filter(e => e.featured).length, 0)}`
);
