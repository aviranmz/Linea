...
export function EventForm({ 
  ...
  const [qualityScore, setQualityScore] = useState<ReturnType<typeof getEventQualityScore> | null>(null)
  ...
  const handleObjectChange = (field: keyof EventFormData, key: string, value: string) => {
    setFormData(prev => ({
      ...prev,
      [field]: {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <div className="bg-white p-6 rounded-lg border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            {getFieldWarning('startDate') && (
              <p className="text-yellow-600 text-sm mt-1">{getFieldWarning('startDate')}</p>
            )}
          </div>
          ...
          <div>
            ...
            {getFieldError('capacity') && (
              <p className="text-red-500 text-sm mt-1">{getFieldError('capacity')}</p>
            )}
          </div>
        ...
        <div className="mt-4">
          ...
          {getFieldError('shortDescription') && (
            <p className="text-red-500 text-sm mt-1">{getFieldError('shortDescription')}</p>
          )}
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-lg border">
        ...
        <div className="mt-4">
          ...
          <div className="space-y-2">
            ...
            <button
              type="button"
              onClick={() => handleArrayChange('features', [...(formData.features || []), ''])}
          ...
          {getFieldError('features') && (
            <p className="text-red-500 text-sm mt-1">{getFieldError('features')}</p>
          )}
        </div>
      </div>
      ...
      {/* Social & Contact */}
      <div className="bg-white p-6 rounded-lg border">
        <h2 className="text-xl font-semibold mb-4">{t('form.socialContact')}</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              onChange={(e) => handleObjectChange('social', 'website', e.target.value)}
              className="input w-full"
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => handleObjectChange('social', 'instagram', e.target.value)}
              className="input w-full"
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => handleObjectChange('social', 'facebook', e.target.value)}
              className="input w-full"
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => handleObjectChange('social', 'linkedin', e.target.value)}
              className="input w-full"
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              onChange={(e) => handleObjectChange('contact', 'email', e.target.value)}
            ...
            {getFieldError('contact') && (
              <p className="text-red-500 text-sm mt-1">{getFieldError('contact')}</p>
            )}
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => handleObjectChange('contact', 'phone', e.target.value)}
              className="input w-full"
      ...
      {qualityScore && (
        <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
          <h2 className="text-xl font-semibold mb-4">{t('form.qualityScore')}</h2>
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 mt-1">
                {qualityScore.score.toFixed(1)} / {qualityScore.maxScore.toFixed(1)} points
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="flex justify-end space-x-4">
        ...
        >
          {loading ? t('form.saving') : mode === 'create' ? t('form.createEvent') : t('form.updateEvent')}
        </button>
      </div>
    </form>
  )
