        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="/" className="text-gray-600 hover:text-indigo-600 text-sm transition-colors duration-200">
                  Events
                </a>
              </li>
              <li>
                <a href="/owner" className="text-gray-600 hover:text-indigo-600 text-sm transition-colors duration-200">
                  Owner Portal
                </a>
              </li>
              <li>
                <a href="/admin" className="text-gray-600 hover:text-indigo-600 text-sm transition-colors duration-200">
                  Admin
                </a>
              </li>
            </ul>
