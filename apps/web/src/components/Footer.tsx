        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
          ...
          <div className='col-span-1 md:col-span-2'>
            ...
            <p className='text-body max-w-md mb-6'>
              Discover and join exclusive events with our innovative waitlist
          ...
          <div>
            ...
            <ul className='space-y-3'>
              <li>
                <Link
                  to='/'
                  className='text-body hover:text-accent-600 transition-colors duration-200'
                >
                  Events
                </Link>
              </li>
        ...
        <div className='mt-12 pt-8 border-t border-neutral-200'>
          <div className='flex flex-col md:flex-row justify-between items-center'>
            ...
            <div className='mt-4 md:mt-0'>
              <p className='text-caption'>Crafted with passion in Milano</p>
            </div>
          </div>
        </div>
      </div>
