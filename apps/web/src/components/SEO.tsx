...
import { SEOData, generateOwnerSEOData, generateEventSEOData, generateOwnerStructuredData, generateEventStructuredData, generateBreadcrumbStructuredData, generateFAQStructuredData, generateOrganizationStructuredData } from '../utils/seo'
...
export function EventSEO({ event, breadcrumbs }: EventSEOProps) {
  ...
  const preloadImages = event.metadata?.heroImageUrl ? [event.metadata.heroImageUrl] : []
...
export function HomeSEO({ featuredEvents: _featuredEvents = [], stats: _stats }: HomeSEOProps) {
  const seoData: SEOData = {
    ...
    keywords: ['Milano Design Week', 'design events', 'designers', 'creative', 'Milano', 'design platform'],
...
export function DesignersPageSEO({ designers = [], totalDesigners = 0 }: DesignersPageSEOProps) {
  const seoData: SEOData = {
    ...
    keywords: ['designers', 'creatives', 'design community', 'Milano', 'portfolio', 'design events'],
  ...
  const breadcrumbs = [
    ...
    { name: 'Designers', url: 'https://linea-production.up.railway.app/designers' }
  ]
