...
export const events: OwnerEvent[] = [
  {
    ...
    description: 'Live demo of integrated quartz worktops with warm walnut cabinetry featuring hidden channels and ambient lighting.',
    startDate: '2025-10-05T18:00:00.000Z',
    status: 'PUBLISHED',
    capacity: 80,
    imageUrl: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?q=80&w=1600'
  },
  {
    ...
    description: 'Selecting, sealing and caring for natural stone countertops with live edge finishing.',
    startDate: '2025-10-07T16:30:00.000Z',
    status: 'PUBLISHED',
    capacity: 50,
    imageUrl: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?q=80&w=1600'
  },
  {
    ...
    description: 'Exploring vertical grain oak, soap-treated finishes, and matte black fixtures.',
    startDate: '2025-10-09T17:00:00.000Z',
    status: 'PUBLISHED',
    capacity: 60,
    imageUrl: 'https://images.unsplash.com/photo-1616596491714-2cf5f2b24f88?q=80&w=1600'
  },
  {
    ...
    description: 'Brass detailing deep-dive: patina control, edge profiles, and lighting temperature.',
    startDate: '2025-10-11T18:30:00.000Z',
    status: 'PUBLISHED',
    capacity: 70,
    imageUrl: 'https://images.unsplash.com/photo-1598300183876-1c39e6b86f66?q=80&w=1600'
  },
  {
    ...
    description: 'Tactile backsplash tiles and diffused light strategies for warm kitchens.',
    startDate: '2025-10-13T17:30:00.000Z',
    status: 'PUBLISHED',
    capacity: 90,
    imageUrl: 'https://images.unsplash.com/photo-1582582621959-48d5d00f50be?q=80&w=1600'
  },
  {
    ...
    description: 'Center islands, pendant geometry, and reflective marble surfaces.',
    startDate: '2025-10-14T19:00:00.000Z',
    status: 'PUBLISHED',
    capacity: 65,
    imageUrl: 'https://images.unsplash.com/photo-1554995207-c18c203602cb?q=80&w=1600'
  },
  {
    id: 'evt_bau_werkflow',
    ...
    description: 'Industrial kitchens with powder-coated steel frames and reclaimed timber.',
    startDate: '2025-10-16T18:15:00.000Z',
    status: 'PUBLISHED',
    capacity: 75,
    imageUrl: 'https://images.unsplash.com/photo-1556911220-e15b29be8c8f?q=80&w=1600'
  },
  {
    id: 'evt_laga_compact',
    ...
    description: 'High-function compact kitchens with light strategies for Nordic winters.',
    startDate: '2025-10-18T16:00:00.000Z',
    status: 'PUBLISHED',
    capacity: 55,
    imageUrl: 'https://images.unsplash.com/photo-1493809842364-78817add7ffb?q=80&w=1600'
  },
  {
    ...
    description: 'Appliance integration, voice control, and NYC–scale storage solutions.',
    startDate: '2025-10-20T17:45:00.000Z',
    status: 'PUBLISHED',
    capacity: 120,
    imageUrl: 'https://images.unsplash.com/photo-1524758631624-e2822e304c36?q=80&w=1600'
  },
  {
    id: 'evt_hikari_zen',
    ...
    description: 'Hidden hardware, shoji-inspired panels, and precision storage.',
    startDate: '2025-10-22T18:00:00.000Z',
    status: 'PUBLISHED',
    capacity: 85,
    imageUrl: 'https://images.unsplash.com/photo-1600585152220-90363fe7e115?q=80&w=1600'
  }
]
