  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sage-50 via-white to-terracotta-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {message && (
          <div className={`mb-4 p-4 rounded-lg shadow-md border ${
        ...
        <form onSubmit={handleSave} className="space-y-6">
          <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 p-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-display font-bold text-gray-900">Business Information</h2>
            </div>
              ...
              <div className="space-y-3">
                {profile.profilePictureUrl && (
                  <div className="flex items-center space-x-3 p-3 bg-gradient-to-r from-terracotta-50 to-gold-50 rounded-lg border border-terracotta-200">
                    ...
                    />
                    <div>
                      <p className="text-xs font-medium text-gray-700">Current profile picture</p>
                      <button
                        type="button"
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 p-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center">
              ...
              <h2 className="text-xl font-display font-bold text-gray-900">Location & Map</h2>
            </div>
            <button
              type="button"
          ...
          {(profile.latitude !== null && profile.longitude !== null && profile.latitude !== 0 && profile.longitude !== 0) && (
            <div className="mb-4">
              <div className="bg-gradient-to-r from-sage-50 to-accent-50 rounded-lg p-4 border border-sage-200">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div className="flex items-center">
                    ...
                    <div>
                      <span className="font-semibold text-gray-800 text-sm">Latitude:</span>
                      <span className="ml-2 text-gray-700 text-sm">{profile.latitude?.toFixed(6) || 'N/A'}</span>
                    </div>
                  </div>
                  <div className="flex items-center">
                    ...
                    <div>
                      <span className="font-semibold text-gray-800 text-sm">Longitude:</span>
                      <span className="ml-2 text-gray-700 text-sm">{profile.longitude?.toFixed(6) || 'N/A'}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full h-32 bg-gradient-to-br from-sage-100 to-accent-100 rounded-lg flex items-center justify-center border-2 border-sage-200">
                <div className="text-center">
                  ...
                  <p className="text-xs font-medium text-gray-700">
                    ...
                    <span className="text-accent-600">Coordinates: {profile.latitude?.toFixed(4) || 'N/A'}, {profile.longitude?.toFixed(4) || 'N/A'}</span>
                  </p>
                </div>
              </div>
            ) : (
      ...
      <div className="mt-8">
        <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 p-6">
          <div className="flex items-center mb-4">
            ...
            <h2 className="text-xl font-display font-bold text-gray-900">Photo Gallery</h2>
          </div>
