...
export function AdminPortal() {
  ...
  useEffect(() => {
    getJson<{ authenticated: boolean; user?: { email: string; role?: string } }>('/auth/me')
      .then((authData) => {
        setAuth(authData)
    ...
    return (
      <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <form onSubmit={requestMagic} className="space-y-4">
          ...
          <button type="submit" className="btn btn-primary w-full">{t('admin.sendMagicLink')}</button>
        </form>
      </div>
    )
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-3xl font-display font-semibold text-neutral-900">{t('admin.portal')}</h1>
                <p className="text-neutral-600 mt-1">{t('admin.portalDescription')}</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <div className="text-right">
                <p className="text-sm text-neutral-500">Logged in as</p>
                <p className="font-medium text-neutral-900">{auth.user?.email}</p>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="p-8">
              <div className="flex items-center justify-between mb-4">
                <div className="w-14 h-14 bg-gradient-to-br from-milano-terracotta/10 to-milano-terracotta/20 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-200">
                  <svg className="w-7 h-7 text-milano-terracotta" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                <p className="text-sm font-medium text-neutral-600 mb-2">{t('admin.totalEvents')}</p>
                <p className="text-3xl font-display font-semibold text-neutral-900 mb-1">
            ...
            <div className="p-8">
              <div className="flex items-center justify-between mb-4">
                <div className="w-14 h-14 bg-gradient-to-br from-milano-sage/10 to-milano-sage/20 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-200">
                  <svg className="w-7 h-7 text-milano-sage" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                <p className="text-sm font-medium text-neutral-600 mb-2">{t('admin.totalWaitlist')}</p>
                <p className="text-3xl font-display font-semibold text-neutral-900 mb-1">
            ...
            <div className="p-8">
              <div className="flex items-center justify-between mb-4">
                <div className="w-14 h-14 bg-gradient-to-br from-milano-gold/10 to-milano-gold/20 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-200">
                  <svg className="w-7 h-7 text-milano-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                <p className="text-sm font-medium text-neutral-600 mb-2">{t('admin.activeEvents')}</p>
                <p className="text-3xl font-display font-semibold text-neutral-900 mb-1">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="card">
            <div className="px-8 py-6 border-b border-neutral-200/50">
              <div className="flex items-center justify-between">
                <h2 className="text-xl font-display font-semibold text-neutral-900">{t('admin.recentActivity')}</h2>
            ...
            <div className="p-8">
              <div className="space-y-6">
                <div className="flex items-start space-x-4 group">
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 bg-gradient-to-br from-milano-sage/10 to-milano-sage/20 rounded-xl flex items-center justify-center group-hover:scale-105 transition-transform duration-200">
                      <svg className="w-6 h-6 text-milano-sage" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                    </div>
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-neutral-900 mb-1">{t('admin.newEventCreated')} "Tech Innovation Summit"</p>
                    <p className="text-xs text-neutral-500 mb-2">Event created and published</p>
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-xs text-neutral-400">2 {t('admin.hoursAgo')}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 group">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-neutral-900 mb-1">{t('admin.newUserRegistered')} john@example.com</p>
                    <p className="text-xs text-neutral-500 mb-2">New user account created</p>
                    <div className="flex items-center space-x-2">
                      <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-accent-100 text-accent-700">
                        Verified
                      </span>
                      <span className="text-xs text-neutral-400">4 {t('admin.hoursAgo')}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 group">
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 bg-gradient-to-br from-milano-terracotta/10 to-milano-terracotta/20 rounded-xl flex items-center justify-center group-hover:scale-105 transition-transform duration-200">
                      <svg className="w-6 h-6 text-milano-terracotta" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                      </svg>
                    </div>
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-neutral-900 mb-1">{t('admin.waitlistEntryAdded')} "Design Week 2024"</p>
                    <p className="text-xs text-neutral-500 mb-2">New waitlist entry submitted</p>
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-xs text-neutral-400">6 {t('admin.hoursAgo')}</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="card">
            <div className="px-8 py-6 border-b border-neutral-200/50">
              <div className="flex items-center justify-between">
                <h2 className="text-xl font-display font-semibold text-neutral-900">{t('admin.systemHealth')}</h2>
                <div className="flex items-center space-x-2">
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between p-4 bg-gradient-to-r from-milano-sage/5 to-milano-sage/10 rounded-xl">
                  <div className="flex items-center space-x-3">
                    <div className="w-10 h-10 bg-milano-sage/20 rounded-lg flex items-center justify-center">
                      <svg className="w-5 h-5 text-milano-sage" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-neutral-900">{t('admin.apiStatus')}</p>
                      <p className="text-xs text-neutral-600">REST API endpoints</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 bg-gradient-to-r from-milano-sage/5 to-milano-sage/10 rounded-xl">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-neutral-900">{t('admin.database')}</p>
                      <p className="text-xs text-neutral-600">PostgreSQL connection</p>
                    </div>
                  </div>
                  <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-milano-sage/20 text-milano-sage border border-milano-sage/30">
                    {t('admin.connected')}
                ...
                <div className="flex items-center justify-between p-4 bg-gradient-to-r from-milano-gold/5 to-milano-gold/10 rounded-xl">
                  <div className="flex items-center space-x-3">
                    <div className="w-10 h-10 bg-milano-gold/20 rounded-lg flex items-center justify-center">
                      <svg className="w-5 h-5 text-milano-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                      </svg>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-neutral-900">{t('admin.redisCache')}</p>
                ...
                <div className="flex items-center justify-between p-4 bg-gradient-to-r from-milano-gold/5 to-milano-gold/10 rounded-xl">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-neutral-900">{t('admin.emailService')}</p>
                      <p className="text-xs text-neutral-600">SMTP configuration</p>
                    </div>
                  </div>
                  <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-milano-gold/20 text-milano-gold border border-milano-gold/30">
                    {t('admin.notConfigured')}
        ...
        <div className="card">
          <div className="px-8 py-6 border-b border-neutral-200/50">
            <div className="flex items-center justify-between">
              <h2 className="text-xl font-display font-semibold text-neutral-900">{t('admin.quickActions')}</h2>
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 bg-accent-500 rounded-full animate-pulse"></div>
                <span className="text-xs text-neutral-500">Administrative tools</span>
              </div>
            </div>
          </div>
          <div className="p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <a href="/admin/users" className="group flex items-center p-6 bg-gradient-to-br from-accent-50 to-accent-100/50 rounded-xl border border-accent-200/50 hover:shadow-milano-lg hover:scale-[1.02] transition-all duration-200">
                ...
                <div className="ml-4">
                  <h3 className="text-sm font-semibold text-neutral-900 group-hover:text-accent-700 transition-colors">Manage All Users</h3>
                  <p className="text-xs text-neutral-600">User management and permissions</p>
                </div>
              </a>
              
              <a href="/admin/owners" className="group flex items-center p-6 bg-gradient-to-br from-milano-terracotta/5 to-milano-terracotta/10 rounded-xl border border-milano-terracotta/20 hover:shadow-milano-lg hover:scale-[1.02] transition-all duration-200">
                ...
                <div className="ml-4">
                  <h3 className="text-sm font-semibold text-neutral-900 group-hover:text-milano-terracotta transition-colors">{t('admin.manageOwners')}</h3>
                  <p className="text-xs text-neutral-600">Owner accounts and profiles</p>
                </div>
              </a>
              
              <a href="/admin/events" className="group flex items-center p-6 bg-gradient-to-br from-milano-sage/5 to-milano-sage/10 rounded-xl border border-milano-sage/20 hover:shadow-milano-lg hover:scale-[1.02] transition-all duration-200">
                ...
                <div className="ml-4">
                  <h3 className="text-sm font-semibold text-neutral-900 group-hover:text-milano-sage transition-colors">{t('admin.reviewEvents')}</h3>
                  <p className="text-xs text-neutral-600">Event moderation and approval</p>
                </div>
              </a>
              
              <a href="/admin/categories" className="group flex items-center p-6 bg-gradient-to-br from-milano-gold/5 to-milano-gold/10 rounded-xl border border-milano-gold/20 hover:shadow-milano-lg hover:scale-[1.02] transition-all duration-200">
                ...
                <div className="ml-4">
                  <h3 className="text-sm font-semibold text-neutral-900 group-hover:text-milano-gold transition-colors">{t('admin.manageCategories')}</h3>
                  <p className="text-xs text-neutral-600">Event categorization system</p>
                </div>
              </a>
              
              <a href="/admin/areas" className="group flex items-center p-6 bg-gradient-to-br from-accent-50 to-accent-100/50 rounded-xl border border-accent-200/50 hover:shadow-milano-lg hover:scale-[1.02] transition-all duration-200">
                <div className="w-12 h-12 bg-gradient-to-br from-accent-500 to-accent-600 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-200 shadow-milano">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="ml-4">
                  <h3 className="text-sm font-semibold text-neutral-900 group-hover:text-accent-700 transition-colors">{t('admin.manageAreas')}</h3>
                  <p className="text-xs text-neutral-600">Geographic regions and zones</p>
                </div>
              </a>
              
              <a href="/admin/products" className="group flex items-center p-6 bg-gradient-to-br from-milano-terracotta/5 to-milano-terracotta/10 rounded-xl border border-milano-terracotta/20 hover:shadow-milano-lg hover:scale-[1.02] transition-all duration-200">
                <div className="w-12 h-12 bg-gradient-to-br from-milano-terracotta to-milano-terracotta/80 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-200 shadow-milano">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="ml-4">
                  <h3 className="text-sm font-semibold text-neutral-900 group-hover:text-milano-terracotta transition-colors">{t('admin.manageProducts')}</h3>
                  <p className="text-xs text-neutral-600">Product catalog management</p>
                </div>
              </a>
              ...
              <button className="group flex items-center p-6 bg-gradient-to-br from-neutral-50 to-neutral-100/50 rounded-xl border border-neutral-200/50 hover:shadow-milano-lg hover:scale-[1.02] transition-all duration-200">
                ...
                <div className="ml-4">
                  <h3 className="text-sm font-semibold text-neutral-900 group-hover:text-neutral-700 transition-colors">{t('admin.systemSettings')}</h3>
                  <p className="text-xs text-neutral-600">Platform configuration</p>
                </div>
              </button>
            </div>
          </div>
