          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-milano-sage/10 to-milano-terracotta/10 rounded-2xl p-8">
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center">
                  <div className="text-3xl font-bold text-milano-sage-600 mb-2">60+</div>
                  <div className="text-sm text-gray-600">Years of Excellence</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-milano-terracotta-600 mb-2">2,000+</div>
                  <div className="text-sm text-gray-600">Exhibitors</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-milano-sage-600 mb-2">300K+</div>
                  <div className="text-sm text-gray-600">Visitors</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-milano-terracotta-600 mb-2">160+</div>
