    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      {events.length === 0 ? (
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">{t('waitlist.noEvents')}</h3>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-neutral-200 overflow-hidden">
          <div className="px-4 sm:px-6 py-4 border-b border-neutral-200">
            <h2 className="text-lg font-semibold text-gray-900">{t('waitlist.eventsWithWaitlists')}</h2>
            <p className="text-sm text-gray-600 mt-1">{t('waitlist.clickEventToManage')}</p>
          </div>
                    ...
                    <td className="px-3 sm:px-4 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <span className="text-sm font-medium text-gray-900">
                          {event.capacity ? Math.floor(event.capacity * 0.1) : 0}
                        </span>
