...
export default function OwnerEventEditor() {
  ...
  const [tab, setTab] = useState<
    'basics' | 'product' | 'media' | 'social' | 'schedule'
  >('basics');
  ...
  return (
    <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10'>
      ...
      <div className='mb-4 border-b border-gray-200'>
        {(['basics', 'product', 'media', 'social', 'schedule'] as const).map(
          t => (
            <button
              key={t}
              className={`px-3 py-2 mr-2 text-sm ${tab === t ? 'border-b-2 border-indigo-600 font-medium' : 'text-gray-600'}`}
              onClick={() => setTab(t)}
            >
            ...
            <div className='grid md:grid-cols-2 gap-4'>
              <div>
                ...
                <input
                  type='datetime-local'
                  className='input w-full'
                  value={new Date(ev.startDate).toISOString().slice(0, 16)}
                  onChange={e =>
                    update({
          ...
          <div className='space-y-4'>
            <div>
              ...
              <input
                ...
                onChange={e => updateMeta({ productName: e.target.value })}
              />
            </div>
            <div>
              ...
              <input
                className='input w-full'
                value={meta.valueProposition || ''}
                onChange={e => updateMeta({ valueProposition: e.target.value })}
              />
            </div>
            <div>
              ...
              <textarea
                ...
                onChange={e => updateMeta({ longDescription: e.target.value })}
              />
            </div>
            <div className='grid md:grid-cols-2 gap-4'>
              <div>
        ...
        {tab === 'media' && (
          <div className='space-y-4'>
            ...
            <div>
              ...
              <input
                className='input w-full'
                value={meta.pressKitUrl || ''}
                onChange={e => updateMeta({ pressKitUrl: e.target.value })}
              />
            </div>
            {/* QR Image URL removed; it is auto-generated by backend */}
          </div>
        )}
        ...
        {tab === 'schedule' && (
          <div className='space-y-2'>
            <p className='text-sm text-gray-600'>
              (Optional) Add schedule items via CSV later. For now, save other
              changes.
            </p>
          </div>
        )}
