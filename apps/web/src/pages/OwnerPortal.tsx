...
export function OwnerPortal() {
  ...
  const handleCreateEvent = async (e: React.FormEvent) => {
    ...
    try {
      const created = await postJson<{ event: Event }>(
        '/api/owner/events',
        payload
      );
      if (created?.event) {
    ...
    try {
      await putJson(`/api/owner/events/${editTarget.id}`, {
        ...
        endDate: editEvent.endDate
          ? new Date(editEvent.endDate).toISOString()
          : null,
    ...
    <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
      ...
      <div className='card mb-8 overflow-hidden'>
            ...
            <div className='flex items-center space-x-4'>
              ...
              <div>
                ...
                {userProfile?.businessName && (
                  <h2 className='heading-3 text-accent-100 mt-1'>
                    {userProfile.businessName}
                  </h2>
                )}
              </div>
        ...
        <div className='px-8 py-6'>
          <p className='text-gray-600 mb-6'>{t('owner.manageEvents')}</p>
          ...
          <div className='bg-white rounded-lg p-8 max-w-md w-full mx-4'>
            ...
            >
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={e =>
                      setNewEvent({ ...newEvent, productName: e.target.value })
                    }
                    className='w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500'
                  />
                </div>
              ...
              <div>
                ...
                <input
                  type='url'
                  value={newEvent.heroImageUrl}
                  onChange={e =>
                    setNewEvent({ ...newEvent, heroImageUrl: e.target.value })
                  }
                  className='w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500'
                />
              </div>
              ...
              <div>
                ...
                <input
                  type='text'
                  value={newEvent.valueProposition}
                  onChange={e =>
                    setNewEvent({
                      ...newEvent,
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                <div>
                  ...
                  <textarea
                    value={newEvent.features}
                    onChange={e =>
                      setNewEvent({ ...newEvent, features: e.target.value })
                    }
                    className='w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500'
                    rows={3}
                  />
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={e =>
                      setNewEvent({ ...newEvent, awards: e.target.value })
                    }
                    className='w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500'
                    rows={3}
                  />
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                <div>
                  ...
                  <input
                    type='url'
                    value={newEvent.socialInstagram}
                    onChange={e =>
                      setNewEvent({
                        ...newEvent,
                ...
                <div>
                  ...
                  <input
                    type='url'
                    value={newEvent.socialTiktok}
                    onChange={e =>
                      setNewEvent({ ...newEvent, socialTiktok: e.target.value })
                    }
                    className='w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500'
                  />
                </div>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                ...
                <div>
                  ...
                  <input
                    type='url'
                    value={newEvent.pressKitUrl}
                    onChange={e =>
                      setNewEvent({ ...newEvent, pressKitUrl: e.target.value })
                    }
                    className='w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500'
                  />
                </div>
              ...
              <div>
                ...
                <input
                  type='url'
                  value={newEvent.qrUrl}
                  onChange={e =>
                    setNewEvent({ ...newEvent, qrUrl: e.target.value })
                  }
                  className='w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500'
                />
              </div>
            ...
            <div className='flex items-center space-x-3'>
              ...
              <div>
                ...
                <p className='text-body text-sm'>
                  {t('owner.manageEventPerformance')}
                </p>
              </div>
            </div>
            <div className='text-right'>
        ...
        <div className='bg-neutral-50 px-8 py-6 border-b border-neutral-200'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4'>
            ...
            <div>
              ...
              <select
                ...
                onChange={e =>
                  setFilters(prev => ({ ...prev, featured: e.target.value }))
                }
              >
          ...
          <div className='mt-4 flex justify-between items-center'>
            <div className='text-sm text-gray-600'>
              {t('owner.showing')} {filteredEvents.length} {t('owner.of')}{' '}
              {events.length} {t('owner.events')}
            </div>
            <button
              type='button'
              onClick={() =>
            ...
            {filteredEvents.map(event => {
              ...
              const getEventImage = (): string => {
                if (
                  ...
                  typeof event.metadata.heroImageUrl === 'string'
                ) {
                  return event.metadata.heroImageUrl;
                }
                if (
                  event.metadata?.videoUrl &&
                  typeof event.metadata.videoUrl === 'string'
                ) {
                  // Extract YouTube video ID and create thumbnail URL
                  const videoId = event.metadata.videoUrl.match(
              ...
              <div className='flex items-center justify-between'>
                <div className='flex items-center space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-body text-sm'>
                      View all users who registered to your events
                    </p>
                  </div>
                </div>
                <div className='flex items-center space-x-4'>
                  <div className='text-right'>
                    ...
                    <p className='heading-2 text-accent-600'>
            ...
            {usersLoading ? (
                          ...
                          <div className='flex items-center space-x-3'>
                            ...
                            <div className='flex-1'>
                              ...
                              <div className='text-xs text-neutral-500 mt-1'>
                                Events: {user.uniqueEvents} • Total:{' '}
                                {user.totalWaitlistEntries}
                                {user.createdAt &&
              ...
              <div className='p-6 text-center'>
                ...
                <p className='text-neutral-500 mb-4'>
                  No users have registered for your events yet, or they don't
              ...
              <div className='flex items-center gap-6'>
                ...
                <label className='flex items-center gap-2 text-sm text-neutral-700'>
                  <input
                    ...
                    onChange={e =>
                      setEditEvent({ ...editEvent, featured: e.target.checked })
                    }
                  />
                  Featured
                </label>
