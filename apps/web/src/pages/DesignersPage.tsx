  ...
  useEffect(() => {
    ...
    if (filters.search) {
      ...
      filtered = filtered.filter(designer => 
        ...
        (designer.businessIntro && designer.businessIntro.toLowerCase().includes(searchLower)) ||
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-body text-lg max-w-3xl mx-auto">
            Explore the creative minds behind Milano Design Week. Find designers, studios, and brands showcasing their latest work.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-neutral-800 rounded-lg shadow-sm border border-neutral-200 dark:border-neutral-700 p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="flex items-end">
              <button
                type="button"
                onClick={() => setFilters({ search: '', category: '', area: '', country: '' })}
