...
export default function AdminAreas() {
  ...
  const toggleActive = async (area: Area) => {
    try {
      ...
      setMessage(
        `Area ${!area.isActive ? 'activated' : 'deactivated'} successfully!`
      );
      loadAreas();
    } catch (error) {
      ...
      <div className='flex items-center justify-between mb-6'>
        <div>
          ...
          <p className='text-sm text-gray-600'>
            Manage business areas and districts
          </p>
        </div>
        <button
                ...
                <div className='grid grid-cols-2 gap-4'>
                  <div>
                    ...
                    <input
                      ...
                      value={newArea.color}
                      onChange={e =>
                        setNewArea(prev => ({ ...prev, color: e.target.value }))
                      }
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      value={newArea.icon}
                      onChange={e =>
                        setNewArea(prev => ({ ...prev, icon: e.target.value }))
                      }
                      placeholder='📍'
                    />
                  </div>
