...
async function queryDatabase() {
  try {
    ...
    emailVerifications.forEach((verification, index) => {
      ...
      console.log(`   Verified: ${verification.verifiedAt ? verification.verifiedAt.toISOString() : 'Not verified'}`)
      console.log(`   Status: ${verification.verifiedAt ? '✅ Verified' : '⏳ Pending'}`)
    })
