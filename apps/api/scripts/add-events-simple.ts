...
async function main() {
  console.log('🌱 Adding events for owner 2 and owner 3 using local database...')
  ...
  const owner2Events = [
    {
      ...
      endDate: new Date(nextWeek.getTime() + 1 * 24 * 60 * 60 * 1000 + 3 * 60 * 60 * 1000), // 3 hours later
      capacity: 50,
      venueId: venues[0].id,
      mapLat: 40.7589,
      mapLng: -73.9851,
    ...
    },
    {
      ...
      endDate: new Date(nextWeek.getTime() + 3 * 24 * 60 * 60 * 1000 + 4 * 60 * 60 * 1000), // 4 hours later
      capacity: 100,
      venueId: venues[1].id,
      mapLat: 40.7505,
      mapLng: -73.9934,
    ...
    },
    {
      ...
      endDate: new Date(nextWeek.getTime() + 5 * 24 * 60 * 60 * 1000 + 3 * 60 * 60 * 1000), // 3 hours later
      capacity: 75,
      venueId: venues[0].id,
      mapLat: 40.7589,
      mapLng: -73.9851,
  ...
  const owner3Events = [
    ...
    },
    {
      ...
      endDate: new Date(nextWeek.getTime() + 4 * 24 * 60 * 60 * 1000 + 4 * 60 * 60 * 1000), // 4 hours later
      capacity: 150,
      venueId: venues[3].id,
      mapLat: 37.7849,
      mapLng: -122.4094,
    ...
    },
    {
      ...
      endDate: new Date(nextWeek.getTime() + 6 * 24 * 60 * 60 * 1000 + 5 * 60 * 60 * 1000), // 5 hours later
      capacity: 80,
      venueId: venues[2].id,
      mapLat: 37.7749,
      mapLng: -122.4194,
